...
y_pred = modelNNthree.predict(x_test)

y_pred_train = modelNNthree.predict(x_train)

plot_model(modelNNthree, to_file='model_three_final.png', show_shapes=True, show_layer_names=True)
