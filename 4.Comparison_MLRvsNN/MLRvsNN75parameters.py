...
y_pred = modelNNall.predict(x_test)

y_pred_train = modelNNall.predict(x_train)

plot_model(modelNNall, to_file='model_all_final.png', show_shapes=True, show_layer_names=True)
